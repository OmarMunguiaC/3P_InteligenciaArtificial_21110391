...
def prim(graph, start_node):
    ...
    :param graph: Diccionario que representa el grafo. Las claves son los nodos y los valores son listas de tuplas (adyacente, peso).
    :param start_node: Nodo inicial para comenzar el algoritmo.
    :return: Lista de aristas que componen el MST.
    """
